...
import tech.intellispaces.commons.reflection.ReflectionFunctions;
import tech.intellispaces.dynamicproxy.DynamicProxies;
import tech.intellispaces.dynamicproxy.sample.InterfaceSample;
import tech.intellispaces.dynamicproxy.sample.InterfaceSampleTracked;
...
public class TrackerFunctionsTest {
  ...
  public void testGetOrCreateTrackedClass() {
    try (MockedStatic<DynamicProxies> dynamicProxy = mockStatic(DynamicProxies.class)) {
      // Given
      dynamicProxy.when(() -> DynamicProxies.getTrackedClass(eq(InterfaceSample.class)))
      ...
      dynamicProxy.verify(() -> DynamicProxies.getTrackedClass(eq(InterfaceSample.class)), times(1));
    }
  }
